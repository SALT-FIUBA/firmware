...
ssize_t rkh_mqttc_pal_sendall(int fd, const void* buf, size_t len, int flags) { return 0; };

ssize_t rkh_mqttc_pal_recvall(int fd, void* buf, size_t bufsz, int flags) { return 0; };
