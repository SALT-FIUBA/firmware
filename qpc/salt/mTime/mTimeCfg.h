/**
 *  \file       mTimeCfg.h
 *  \brief      Main timer definitions.
 *
 *  Changes Made:

            Replaced RKH include and macros with QPC include and macros.
            Adapted RKH_TICK_RATE_MS to QF_TICK_RATE_MS.
 */
 ...
 */
#define MTIME_TIME_TICK         QF_TICK_RATE_MS   /* Expressed in msec */
